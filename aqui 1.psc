Funcion bonoAntiguedad <- Yearsantiguedad (añosAntiguedad,porcentajeBono)
...
Algoritmo sin_titulo
	...
	SiNo
		RCIVA <- 0
	FinSi
	ingresosTotales <- haberBasico+Yearsantiguedad(añosAntiguedad,porcentajeBono)+sueldoHorasExtra+sueldoBonoProductividad+sueldoBonosExtra
